...
function [alpha_final,alpha_1_raw,alpha_2_raw,Spectrum] = pertAbsorption(alpha, T_etalon, Model, Range, Time, Spectrum, HSRL, ind_r_lo,ind_r_hi, Options, alpha_err)
